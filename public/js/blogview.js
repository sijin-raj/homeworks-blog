...
!(function($) {
  ...
  //  console.log('doc',doc) 
    ...
    <div class="  sm:ml-10 lg:ml-16 mb-10"   data-id='${doc.id}'>
    <!--Lead Para-->
...
<div class=" items-center px-4 justify-center">
  <img class="container w-full max-w-4xl  absloute mx-auto bg-white bg-cover rounded" src="${doc.image}" height="55vh"></img>
</div>
