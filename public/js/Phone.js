...
const renderUser = (doc) => {
  const tr = `
                          ...
                          <div class="flex-1  mt-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg  "  data-id='${
                            doc.id
                          }'>
                              <a href="blogviews.html?projectid=${doc.id}" class="flex flex-wrap no-underline hover:no-underline">
                                  <img   src="${
                                    doc.data().image
...
var docRef = db.collection("phone");
